...
if __name__ == "__main__":
    ...
    #cơ chế của Breakpoint/Conditonal Breakpoint: phá vỡ khi vòng lặp khi đạt 1 giá trị đã đặt sẵn 
    #cơ chế ẩn/hiển thị của các Logging Levels: gọi nhiều lần đóng vai trò là tham số của chương trình 
    #lỗi logic được gây ra bởi: sử dụng biến và Wach sai cách
